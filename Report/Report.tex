...
Para la parte del análisis léxico se tomaron las expresiones regulares de lenguaje C de la siguiente \href{https://www.lysator.liu.se/c/ANSI-C-grammar-l.html}{página web}.

\subsection*{Análisis sintáctico}
Para desarrollar el analizador sintáctico se tomó la gramática de lenguaje C de la siguiente \href{https://www.lysator.liu.se/c/ANSI-C-grammar-y.html}{página web}.
